...
public class PurchaseModel {
    ...
    public PurchaseModel(String id, String lottery_date, String lottery_number,
                         String lottery_amount, String lottery_paid, String lottery_status,
                         String lottery_value, int value, String timeStamp) {
        this.id = id;
